...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center py-20">
      <h1 className="text-[20px] leading-[28px] font-semibold text-text-primary mb-2">Not Found</h1>
      <p className="text-body text-text-muted mb-6">This page doesn't exist.</p>
      <Link
        href="/"
